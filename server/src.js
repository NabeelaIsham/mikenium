...
app.get('/api/health',(req,res)=>res.json({status:'ok'})); app.use('/api/auth',authRoutes); app.use('/api/projects',publicProjectRoutes); app.use('/api/services',publicServiceRoutes); app.use('/api/products',publicProductRoutes); app.use('/api/pricing',publicPricingRoutes); app.use('/api/blogs',publicBlogRoutes); app.use('/api/testimonials',publicTestimonialRoutes); app.use('/api/partners',publicPartnerRoutes); app.use('/api/contact',publicContactRoutes); app.use('/api/newsletter',newsletterRoutes); app.use('/api/admin/dashboard',dashboardRoutes); app.use('/api/admin/users',userRoutes); app.use('/api/admin/clients',clientRoutes); app.use('/api/admin/projects',projectRoutes); app.use('/api/admin/services',serviceRoutes); app.use('/api/admin/products',productRoutes); app.use('/api/admin/pricing',pricingRoutes); app.use('/api/admin/blogs',blogRoutes); app.use('/api/admin/testimonials',testimonialRoutes); app.use('/api/admin/partners',partnerRoutes); app.use('/api/admin/contact-messages',contactMessageRoutes);
