...
export async function uploadProjectImage(file){
  const response=await fetchWithTimeout(`${API_URL}/api/admin/projects/image-upload`,{
    method:'POST',
    credentials:'include',
...
export async function uploadProductImage(file){
  const response=await fetchWithTimeout(`${API_URL}/api/admin/products/image-upload`,{method:'POST',credentials:'include',headers:{'Content-Type':file.type},body:file},30000);
  const data=await response.json().catch(()=>({}));
...
export async function uploadBlogImage(file){
  const response=await fetchWithTimeout(`${API_URL}/api/admin/blogs/image-upload`,{method:'POST',credentials:'include',headers:{'Content-Type':file.type},body:file},30000);
  const data=await response.json().catch(()=>({}));
...
export async function uploadTestimonialAvatar(file){
  const response=await fetchWithTimeout(`${API_URL}/api/admin/testimonials/image-upload`,{method:'POST',credentials:'include',headers:{'Content-Type':file.type},body:file},30000);
  const data=await response.json().catch(()=>({}));
...
export const deleteContactMessage=id=>adminRequest(`/api/admin/contact-messages/${id}`,{method:'DELETE'});
...
export async function uploadPartnerLogo(file){
  const response=await fetchWithTimeout(`${API_URL}/api/admin/partners/logo-upload`,{method:'POST',credentials:'include',headers:{'Content-Type':file.type},body:file},30000);
  const data=await response.json().catch(()=>({}));
...
export async function uploadSiteIdentityImage(file){
  const response=await fetchWithTimeout(`${API_URL}/api/admin/settings/identity-upload`,{method:'POST',credentials:'include',headers:{'Content-Type':file.type},body:file},30000);
  const data=await response.json().catch(()=>({}));
