  ...
  return <div className="public-site about-page">
    ...
    <main>
      ...
      <section className="about-story reveal" id="story">
        <div className="story-visual"><div className="story-photo"><img src="/assets/about-team-studio-v2.jpg" width="1694" height="929" loading="lazy" decoding="async" alt="Mikenium product team collaborating in our software studio"/><span className="photo-caption"><i/> COLOMBO · SRI LANKA</span></div><div className="impact-badge"><I.TrendingUp/><span><b>Real impact</b><small>Not just deliverables</small></span></div><div className="story-quote"><I.Quote/><p>Technology works best when it feels human.</p></div></div>
